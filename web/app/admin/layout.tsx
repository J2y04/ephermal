...
import { IconGrid, IconUsers, IconDatabase, IconCreditCard, IconShield, IconTriangle, IconArrowLeft, IconFlask, IconMail } from './lib/icons';
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const nav = [
    ...
    { href: '/admin/inbox', label: 'Inbox', Icon: IconMail },
