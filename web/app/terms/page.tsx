    ...
    <>
      ...
      <div className="legal-page">
        ...
        <div className="legal-section">
          ...
          <ul>
            <li><strong>Free trial</strong> — where offered, a free trial converts automatically to a paid subscription at the end of the trial unless cancelled. You will receive a reminder at least 3 days before conversion.</li>
